            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-1">Explorateur de Disque</h3>
                    <p className="text-blue-100 text-sm">Trouvez les fichiers et dossiers qui prennent le plus d'espace</p>
                  </div>
                </div>
